...
Application.prototype.init = function(options) {
    ...
    this.__defineGetter__('invoker', function(){
//        this.__usedInvoker = true;
        return require('./invoker')(this.__remotes);
    });
...
Application.prototype.addModel = function(name, model) {
    ...
    this.remotes.exports[name] = model;
    model.app = this;
...
Application.prototype['with'] = function (context) {
    context = context || {};
    var self = this;
    return {
        handle: function(uri, payload, cb) {
            var req;
...
Application.prototype.handle = function(name, payload, cb) {
    return this.with().handle(name, payload, cb);
};
